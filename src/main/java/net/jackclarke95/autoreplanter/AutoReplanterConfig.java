...
public class AutoReplanterConfig {
        ...
        /**
         * Controls when auto-replanting should occur based on the player's sneak state.
         * <p>
         * Available options:
         * <ul>
         * <li>{@link SneakMode#ALWAYS} - Works regardless of sneak state (default)</li>
         * <li>{@link SneakMode#ONLY_SNEAKING} - Only works while sneaking</li>
         * <li>{@link SneakMode#ONLY_STANDING} - Only works while not sneaking</li>
         * </ul>
         * </p>
         * 
         * @default ALWAYS
         * @see SneakMode
         */
        public SneakMode sneakMode = SneakMode.ALWAYS;

        /**
         * Gets the sneak mode, ensuring it's never null.
         * 
         * @return the configured sneak mode, or ALWAYS if null
         */
